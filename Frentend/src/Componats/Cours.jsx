...
function Cours() {
  ...
  <div>
    <h1>"Immerse yourself in the captivating world of literature with our selection of the best books. From timeless classics to contemporary masterpieces, each page invites you on a journey of discovery and imagination.
...
Let the best books be your companions on a journey of discovery, enlightenment, and sheer enjoyment. Open a book today and embark on an adventure that will stay with you long after the final chapter."</h1>
  </div>
  <br />
  <br />
  <div className='flex justify-center items-center'>
    <Link to="/">
    <button className='bg-black-500 hover:bg-grey-900 text-white font-bold py-2 px-5 rounded-full border border-white-500'>back</button>
    </Link>
  </div>
  <br />
  <br />
